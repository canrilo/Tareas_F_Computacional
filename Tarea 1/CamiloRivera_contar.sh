...
echo 'Número de apariciones de 0'
grep -o "0" random_3D.dat |wc -l
echo 'Número de apariciones de 1'
grep -o "1" random_3D.dat |wc -l
echo 'Número de apariciones de 2'
grep -o "2" random_3D.dat |wc -l
echo 'Número de apariciones de 3'
grep -o "3" random_3D.dat |wc -l
echo 'Número de apariciones de 4'
grep -o "4" random_3D.dat |wc -l
echo 'Número de apariciones de 5'
grep -o "5" random_3D.dat |wc -l
echo 'Número de apariciones de 6'
grep -o "6" random_3D.dat |wc -l
echo 'Número de apariciones de 7'
grep -o "7" random_3D.dat |wc -l
echo 'Número de apariciones de 8'
grep -o "8" random_3D.dat |wc -l
echo 'Número de apariciones de 9'
